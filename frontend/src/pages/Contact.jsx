  ...
  return (
    <>
      ...
      <div className="relative z-10 w-full flex justify-center items-center mt-32 px-6">
        ...
        >
          <h2 className="text-white text-2xl md:text-4xl font-semibold mb-6">Contact Us</h2>
          <p className="text-[#c2c2c2] mb-6 text-sm md:text-md">
            Got questions or suggestions? Reach out and we'll get back to you as soon as possible.
          </p>
